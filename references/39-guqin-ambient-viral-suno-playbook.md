...
- 旧物叙事必须有职业手和动作：修琴、补漆、拓碑、装帧、补瓷、擦灰、换弦、贴拾音器、侧敲编钟、听旧磁带。
- 《旧音十境》优先选择事实自带声音奇观的主题，例如编钟“一钟双音”、断纹古琴、残谱复声；这种主题比单纯旧物更容易形成标题级 Hook。
...
- 物件优先：断纹、编钟、青铜铭文、拾音器、拓包、碑灰、旧唱针、纸页、碎瓷、铜钟、木窗、香灰。
- 时间锚优先：`8:00`、`15:00`、`第7天`、`某年某月`、`一百年前`，但每段不超过 1-2 个数字，避免报数感。

## 编曲执行

- 核心声音武器只选 2-3 个：guqin harmonics、bianzhong side strike、bronze resonance tail、xiao breath、temple bell、woodblock pulse、vinyl dust crackle。
...
```text
Chinese ancient bronze bell ambient vocal, old-object restoration narrative, restrained female vocal, bianzhong chime lead, guqin low drone, xiao breath, soft woodblock pulse, bronze side-strike resonance sound logo, 70 BPM, minor pentatonic color, close upfront vocal, clear melodic chorus, phone-speaker clear mix, short reverb tail, stripped verse to solemn chorus lift.
```
...
(bronze bell side strike, close breath, room silence)
...
- 每段是否有手上动作：擦、补、拓、吹、换、停、听、按住、贴拾音器、正敲、侧敲。
- 每段是否有可触摸物件：青铜、铭文、拾音器、槌、灰、纸、弦、木窗、铜钟。
